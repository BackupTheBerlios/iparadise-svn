...
import static org.apache.commons.chain.Command.PROCESSING_COMPLETE;
 ...
 * Time: 15:50:11
 */
public class SearchWebCommand extends G16GenericWebCommand implements G16WebCommand {
    public boolean execute(Context context) throws Exception {
        ...
        Object result;
        boolean resultStatus = CONTINUE_PROCESSING;
        try {
            result = defaultInvokeBusiness(GenericCommandsEnum.process, args);
            BeanUtils.setProperty(g16ChainContext.getBean(), formPropName, result);
        } catch (BusinessException e) {
            resultStatus = PROCESSING_COMPLETE;
            throw e;
