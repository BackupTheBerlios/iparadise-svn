 ...
 * Time: 15:50:11
 */
public class UpdateWebCommand extends G16GenericWebCommand implements G16WebCommand {
    public boolean execute(Context context) throws Exception {
        ...
        boolean result = Command.CONTINUE_PROCESSING;
        try {
            defaultInvokeBusiness(GenericCommandsEnum.insertObject, args);
        } catch (BusinessException e) {
            result = Command.PROCESSING_COMPLETE;
            throw e;
